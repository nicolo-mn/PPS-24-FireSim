...
class MoveStrategyTest extends AnyFlatSpec with Matchers {
  ...
  "BresenhamMovement" should "generate a straight horizontal path" in {
    ...
    path shouldBe List((1, 0), (2, 0), (3, 0), (3, 0)) // repeats last cell
  }

  it should "generate a straight vertical path" in {
    val path = bresenham((0, 0), (0, 3)).take(4).toList
    path shouldBe List((0, 1), (0, 2), (0, 3), (0, 3))
  }

  it should "generate a diagonal path" in {
    val path = bresenham((0, 0), (3, 3)).take(4).toList
    path shouldBe List((1, 1), (2, 2), (3, 3), (3, 3))
  }

  it should "generate a shallow slope path" in {
    val path = bresenham((0, 0), (5, 2)).take(6).toList
    path shouldBe List((1, 0), (2, 1), (3, 1), (4, 2), (5, 2), (5, 2))
  }

  it should "generate a steep slope path" in {
    val path = bresenham((0, 0), (2, 5)).take(6).toList
    path shouldBe List((0, 1), (1, 2), (1, 3), (2, 4), (2, 5), (2, 5))
  }

  it should "work when moving backwards horizontally" in {
    val path = bresenham((3, 0), (0, 0)).take(4).toList
    path shouldBe List((2, 0), (1, 0), (0, 0), (0, 0))
  }

  it should "work when moving backwards vertically" in {
    val path = bresenham((0, 3), (0, 0)).take(4).toList
    path shouldBe List((0, 2), (0, 1), (0, 0), (0, 0))
  }

  it should "work when moving diagonally backwards" in {
    val path = bresenham((3, 3), (0, 0)).take(4).toList
    path shouldBe List((2, 2), (1, 1), (0, 0), (0, 0))
  }
